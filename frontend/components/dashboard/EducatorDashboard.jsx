...
export default function EducatorDashboard() {
  ...
  return (
    ...
    >
      ...
      {/* Needs attention: alerts + complaints, the two time-sensitive queues */}
      ...
      {/* Classroom roster + communications */}
      <section className="grid gap-6 lg:grid-cols-2">
        <div className="card p-6">
      ...
      {/* Live collaboration + quick actions */}
      <section className="grid gap-6 lg:grid-cols-2">
        <div className="card p-6">
      ...
      {/* AI surface, lower priority than actionable data above */}
      <AISpotlightBanner
        ...
        secondaryAction={{ label: 'Communication Hub', href: '/communication-hub#copilot-response-center' }}
      />
    </AppShell>
  )
}
