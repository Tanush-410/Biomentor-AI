  ...
  return (
    <div className="grid gap-6 xl:grid-cols-[1.1fr_0.9fr]">
      <div className="card p-6">
        <p className="section-kicker text-[#8a5a36]">Live sessions</p>
                ...
                <div className="flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
                  <div>
                    ...
                    {session.scheduled_for && (
                      <p className="mt-3 inline-flex items-center gap-2 text-sm text-[#6d472d]">
                  ...
                  {session.meeting_url ? (
                    ...
                    <div className="rounded-full bg-[#f5ebdf] px-3 py-2 text-xs font-semibold uppercase tracking-[0.2em] text-[#6d472d]">
                      Link pending
                    </div>
                  )}
                </div>
      ...
      {role === 'student' ? (
        <div className="card p-6">
          <p className="section-kicker text-[#8a5a36]">Attendance flow</p>
        ...
        <div className="space-y-6">
          <form onSubmit={handleSchedule} className="card p-6">
            <p className="section-kicker text-[#8a5a36]">Schedule</p>
          ...
          <form onSubmit={handleStart} className="card p-6">
            <p className="section-kicker text-[#8a5a36]">Go live</p>
