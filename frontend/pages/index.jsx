  ...
  return (
    <main className="flex min-h-screen flex-col overflow-hidden bg-[#f4f4f5] text-[#09090b]">
      <section className="relative px-6 py-6 md:px-10 lg:px-16">
        ...
        <header className="relative mx-auto flex w-full max-w-7xl flex-wrap items-center justify-between gap-5 border-b border-zinc-200 bg-white/80 px-1 py-7 backdrop-blur md:px-0">
          <div>
            <StemEducationBadge />
      ...
      <section className="relative flex-1 overflow-hidden bg-[radial-gradient(circle_at_15%_20%,rgba(255,255,255,0.06),transparent_45%),linear-gradient(150deg,#0a0a0b_0%,#18181b_55%,#0a0a0b_100%)]">
        <div className="relative mx-auto grid w-full max-w-7xl grid-cols-1 items-center gap-4 px-6 py-20 md:px-10 lg:grid-cols-[0.85fr_1.15fr] lg:gap-2 lg:px-16 lg:py-28">
          ...
          <div className="h-[320px] w-full md:h-[420px] lg:h-[520px]">
            <ConstellationHero className="h-full w-full" />
          </div>
        </div>
      </section>

      <Footer className="border-zinc-200 bg-[#f4f4f5]" />
    </main>
  )
}
