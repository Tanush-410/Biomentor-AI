    ...
    <main className="min-h-screen overflow-hidden bg-[#f4f4f5] text-[#09090b]">
        ...
        <div className="relative mx-auto max-w-7xl">
          <header className="flex flex-wrap items-center justify-between gap-5 border-b border-zinc-200 bg-white/80 px-1 py-7 backdrop-blur md:px-0">
            ...
            <nav className="flex items-center gap-3">
              ...
              <Link href="/register" className="rounded-full bg-black px-6 py-3 text-sm font-black text-white shadow-[0_16px_34px_rgba(0,0,0,0.2)] transition hover:-translate-y-0.5 hover:bg-zinc-800">
                Create Account
              </Link>
            </nav>
          </header>
          ...
          <div className="grid gap-6 py-12 lg:grid-cols-[1.05fr_0.95fr] lg:py-16">
            <div className="relative overflow-hidden rounded-[2.5rem] bg-black p-7 text-white shadow-[0_34px_90px_rgba(0,0,0,0.28)] md:p-10 lg:min-h-[620px]">
              <div className="absolute inset-0 bg-[radial-gradient(circle_at_70%_28%,rgba(255,255,255,0.16),transparent_34%),linear-gradient(145deg,rgba(255,255,255,0.1),transparent_45%)]" />
              <div className="relative z-10 flex h-full flex-col justify-between gap-14">
                <div>
                  <p className="section-kicker text-zinc-300">Adaptive learning workspace</p>
                  ...
                  <p className="mt-7 max-w-2xl text-lg font-semibold leading-8 text-zinc-300 md:text-xl">
                ...
                <div className="flex flex-wrap gap-3">
                  <Link href="/login?mode=student" className="btn bg-white text-black hover:bg-zinc-200">
      ...
      <section className="px-6 py-10 md:px-10 lg:px-16">
        <div className="mx-auto grid max-w-7xl gap-6 lg:grid-cols-[0.9fr_1.1fr]">
          <div className="rounded-[2.4rem] bg-black p-8 text-white shadow-[0_30px_90px_rgba(0,0,0,0.24)] md:p-10">
            <p className="section-kicker text-zinc-300">Assessment, proctoring, certificates</p>
          ...
          <div className="grid lg:grid-cols-[0.95fr_1.05fr]">
            <div className="p-8 md:p-10">
              ...
              <div className="mt-7 flex flex-wrap gap-3">
                <Link href="/login?mode=educator" className="btn bg-black text-white hover:bg-zinc-800">
...
function HeroSignal({ label, value }) {
  return (
    <div className="rounded-[1.5rem] border border-white/15 bg-white/10 p-4 backdrop-blur">
      <p className="text-[0.65rem] font-black uppercase tracking-[0.34em] text-zinc-300">{label}</p>
